...
| [2026-09 — Unbuffered TLS send path](2026-09-unbuffered-tls.md) | Sep 2026 · PR #338 | Foundation for encrypting from caller memory into the pool slot: module split, CiphertextBuf, feature gate. kTLS deferred (extract_secrets is all-or-nothing) |
