...
//! structs ([`FrameHeader`], [`frame::Priority`], [`Settings`],
...
//! and event enums are `#[non_exhaustive]`; [`ErrorCode`] is deliberately
//! exhaustive (RFC-fixed, unknown codes fold to `InternalError`).
//!
//! # Architecture
//!
//! ```text
